...
// Source: ./pkg/kubevirt/machine_factory.go
//
// Generated by this command:
//
//	mockgen -source=./pkg/kubevirt/machine_factory.go -destination=./pkg/kubevirt/mock/machine_factory_generated.go -package=mock_kubevirt
//
...
func (mr *MockMachineInterfaceMockRecorder) Create(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMachineInterfaceMockRecorder) DrainNodeIfNeeded(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockMachineFactory) NewMachine(ctx *context0.MachineContext, arg1 client.Client, namespace string, sshKeys *ssh.ClusterNodeSshKeys) (kubevirt.MachineInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewMachine", ctx, arg1, namespace, sshKeys)
...
func (mr *MockMachineFactoryMockRecorder) NewMachine(ctx, arg1, namespace, sshKeys any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewMachine", reflect.TypeOf((*MockMachineFactory)(nil).NewMachine), ctx, arg1, namespace, sshKeys)
}

// NewMachineWithIPs mocks base method.
func (m *MockMachineFactory) NewMachineWithIPs(ctx *context0.MachineContext, arg1 client.Client, namespace string, sshKeys *ssh.ClusterNodeSshKeys, allocatedIPs []*net.IPNet) (kubevirt.MachineInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewMachineWithIPs", ctx, arg1, namespace, sshKeys, allocatedIPs)
	ret0, _ := ret[0].(kubevirt.MachineInterface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// NewMachineWithIPs indicates an expected call of NewMachineWithIPs.
func (mr *MockMachineFactoryMockRecorder) NewMachineWithIPs(ctx, arg1, namespace, sshKeys, allocatedIPs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewMachineWithIPs", reflect.TypeOf((*MockMachineFactory)(nil).NewMachineWithIPs), ctx, arg1, namespace, sshKeys, allocatedIPs)
}
